...
# iuyoon custom made 230103
cub200_template = [
    lambda c: f'a photo of a {c}.',
    lambda c: f'a photo of the {c}.',
    lambda c: f'a photo of a bird {c}.',
    lambda c: f'a photo of the bird {c}.',
    lambda c: f'a zoomed in bird photo of a {c}.',
    lambda c: f'a centered bird photo of a {c}.',
    lambda c: f'a close up bird photo of a {c}.',
]
...
dataset_to_template = {
    ...
    'mini_imagenet': mini_imagenet_template,
